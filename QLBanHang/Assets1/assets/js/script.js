...
/*$("body").append('<div class="fixed-button active"><a href="https://codedthemes.com/item/flash-able-bootstrap-admin-template/" target="_blank" class="btn btn-md btn-primary"><i class="fa-solid fa-clover" aria-hidden="true"></i> Chúc bạn 1 ngày tốt lành</a> </div>');var $window=$(window),nav=$(".fixed-button");*/
